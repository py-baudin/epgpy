...
plt.legend()
plt.grid()
plt.title(r"SPGR approach to steady-state for $\Phi_0$=117")
...
plt.ylabel(r"Signal / $M_0$")
plt.title(r"SPGR steady-state dependence on $\Phi_0$")
...
plt.grid()
plt.legend(loc="lower right")
plt.title(r"Myelin water exch. ($\delta$b=0.1ppm)")
plt.ylim(0, 0.2)
plt.xlim(-100, 100)
